...
* **Noise Sensitivity:** Salt & Pepper noise destroys structural data and plummets accuracy incredibly fast, whereas the model remains highly resilient to Poisson noise.
